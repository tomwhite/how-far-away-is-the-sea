...
public class HowFarAwayIsTheSea {

  private final URL landGeometry;
  private final URL oceanGeometry;

  public HowFarAwayIsTheSea(URL landGeometry, URL oceanGeometry) {
  ...
  public static void main(String[] args) throws Exception {
    if (args.length != 4) {
      System.err.println("Usage: " + HowFarAwayIsTheSea.class.getSimpleName() +
    ...
    HowFarAwayIsTheSea coaster = new HowFarAwayIsTheSea(landShapeFile.toURL(), oceanShapeFile.toURL());
